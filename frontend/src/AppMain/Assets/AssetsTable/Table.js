              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left"> {row.status} <LinearProgress color={status_colors[row.status]} variant="determinate" value={50} valueBuffer={50} /></TableCell>
                    <TableCell align="left"> {row.location} </TableCell>
                    <TableCell align="left"> {new Date(row.warranty_expiration_date).toUTCString()}
                    <LinearProgress color={(new Date().getTime() < new Date(row.warranty_expiration_date).getTime())  ? 'success':'warning'} variant="determinate" value={75} valueBuffer={0} /> 
