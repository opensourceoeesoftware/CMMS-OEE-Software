  ...
  return (
    ...
    return (
        ...
        >
            ...
            <TableCell align="left">{row.assigned_to?.username}</TableCell>
            <TableCell align="left">{row.asset?.name}</TableCell>
            <TableCell align="left">{new Date(row.planned_starting_date).toUTCString()}</TableCell>
            <TableCell align="left">{row.started_at?new Date(row.started_at).toUTCString() : 'Not started'}</TableCell>
            <TableCell align="left">{row.type}</TableCell>
            <TableCell align="left">{row.priority}</TableCell>
            <TableCell align="left">{row.status} <LinearProgress color={statusColors[row.status]} variant="determinate" value={50} valueBuffer={50} /></TableCell>
