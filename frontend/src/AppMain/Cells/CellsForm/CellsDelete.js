...
class CellsDelete extends Component {
    constructor(props) {
        super(props)
        this.state = {
            is_loading:false
    ...
    render() {
      ...
      >
        <DialogTitle id="alert-dialog-title">
          {"Are you sure you want to delete the selected cells?"}
        </DialogTitle>
        <DialogContent>
          ...
          <strong> You have selected {this.props.AssetsToDelete} Cells to delete</strong>
          </DialogContentText>
          <br></br>
          <DialogContentText id="alert-dialog-description">
